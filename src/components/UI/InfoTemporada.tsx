      ...
      >
        <div className="bg-gradient-to-tr from-gray-900">
          ...
          <div className=" md:h-[75vh] pt-20  ">
            ...
            <div className="flex flex-col gap-2.5 pb-8 mx-4 md:mt-9 md:mx-20  ">
              <Description description={description} />
            </div>
          </div>
        </div>
      </div>
      <div className="bg-gray-900 flex flex-col gap-2.5 px-4 md:pt-9 md:px-20 pb-10">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {load &&
              episodes.map((e, index) => (
                <div
                  className="bg-gray-800 rounded-xl grid grid-cols-12 gap-4 cursor-pointer  "
                  onClick={playVideo}
                >
                  <img
